...
```{r}
tab_model(mod_true_intercept, mod_true_predictors, mod_true_randomslope, mod_true_interaction)
```
...
```{r}
tab_model(mod_cca_intercept, mod_cca_predictors, mod_cca_randomslope, mod_cca_interaction)
```
...
```{r}
# tab_model(mod_imp_intercept, mod_imp_predictors, mod_imp_randomslope, mod_imp_interaction)
```
